<?php
// This script tests if the API endpoint with stock validation works

$url = 'http://localhost/agrostore/api/orders/index_test.php';

// First, create a test product via cURL
$testProduct = [
    'name' => 'Test Product with 2 Stock',
...
if (isset($result['product_id'])) {
    ...
    echo "Attempting to create order with quantity 5 (stock is 2)...\n\n";
